...
func _init() -> void:
	...
	bounds_cell_type.cell_appearance_index = appearance_set.get_cell_appearance_index_by_name('environment_cell_bounds')
	bounds_cell_type.add_gene(ImmortalityGene)
	
	empty_cell_type = add_cell_type()
	empty_cell_type.name = 'Empty'
	empty_cell_type.cell_appearance_index = appearance_set.get_cell_appearance_index_by_name('environment_cell_empty')
	...
	food_cell_type.cell_appearance_index = appearance_set.get_cell_appearance_index_by_name('environment_cell_food')
	...
	toxin_cell_type.cell_appearance_index = appearance_set.get_cell_appearance_index_by_name('environment_cell_toxin')
