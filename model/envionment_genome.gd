...
static func _static_init() -> void:
	...
	bounds_cell_type.add_gene(ImortalityGene)
	...
	empty_cell_type.add_gene(ImortalityGene)
	...
	food_cell_type.add_gene(ImortalityGene)
	...
	toxin_cell_type.add_gene(ImortalityGene)
